...
if (!$user) {
    ...
    // Only logout if we are SURE it's not a connection error
    if (isset($laporanPdo)) {
        session_destroy();
        header("Location: ../login.php");
        exit();
...
<body>
    ...
    <div class="container py-4">
        ...
        <script>
            ...
            document.getElementById('photo') && document.getElementById('photo').addEventListener('change', function (e) {
                const file = e.target.files[0];
                if (file) {
                    // Show file name
                    if (document.getElementById('fileName')) document.getElementById('fileName').textContent = file.name;
